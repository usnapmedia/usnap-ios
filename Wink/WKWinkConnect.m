...
#define WINK_API_URL @"http://d.tanios.ca/usnap/api/v1"
...
+ (AFHTTPRequestOperation *)winkConnectGetUserInfo:(NSString *)accessToken
    ...
    AFHTTPRequestOperation *operation =
        [WKWinkConnect requestWithUrl:url type:GET path:nil params:nil data:nil accessToken:accessToken success:success failure:failure];
    [operation start];
    return operation;
}
...
//    }
//    AFHTTPRequestOperation *operation = [WKWinkConnect requestWithUrl:url
//                                                                 type:POST
//                                                                 path:nil
//                                                               params:[NSDictionary dictionaryWithObjectsAndKeys:text, @"text", nil]
//                                                                 data:data
...
+ (AFHTTPRequestOperation *)requestWithUrl:(NSString *)urlString
    ...
    if (data == nil) {
        ...
        request = [manager.requestSerializer
            multipartFormRequestWithMethod:type
                                 URLString:urlString
                                parameters:params
